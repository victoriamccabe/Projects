...
using YourProjectName.Areas.Rental.Models;
...
namespace TheatreCMS3.Areas.Rent.Controllers
{
    public class RentalHistoriesController : Controller
    {
        ...
        {
            // Fetch all rental histories ordered by most recent first
            var rentals = db.RentalHistories
                .OrderByDescending(r => r.RentalHistoryId) // or r.RentalDate if you have that field
                .ToList();
